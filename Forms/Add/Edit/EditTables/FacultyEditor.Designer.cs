namespace CafedralDB.Forms.Add.Edit.EditTables
{
	partial class FacultyEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.facultyTableAdapter = new CafedralDB.MainDBDataSetTableAdapters.FacultyTableAdapter();
			...
			this.dataGridView1.Size = new System.Drawing.Size(333, 124);
			this.dataGridView1.TabIndex = 0;
			// 
			// facultyBindingSource
			// 
			this.facultyBindingSource.DataMember = "Faculty";
			this.facultyBindingSource.DataSource = this.mainDBDataSet;
			// 
			// mainDBDataSet
			// 
			...
			this.splitContainer1.Size = new System.Drawing.Size(333, 153);
			...
			this.Load += new System.EventHandler(this.FacultyEditor_Load);
		...
		private MainDBDataSetTableAdapters.FacultyTableAdapter facultyTableAdapter;
